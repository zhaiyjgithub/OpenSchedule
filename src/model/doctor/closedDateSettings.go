...
type ClosedDateSettings struct {
	...
	AmStartTime	string	`gorm:"column:am_start_time;type:varchar(5)" json:"amStartTime" validate:"omitempty,hh:mm"`
	AmEndTime	string	`gorm:"column:am_end_time;type:varchar(5)" json:"amEndTime" validate:"omitempty,hh:mm"`
	PmStartTime	string	`gorm:"column:pm_start_time;type:varchar(5)" json:"pmStartTime" validate:"omitempty,hh:mm"`
	PmEndTime	string	`gorm:"column:pm_end_time;type:varchar(5)" json:"pmEndTime" validate:"omitempty,hh:mm"`
