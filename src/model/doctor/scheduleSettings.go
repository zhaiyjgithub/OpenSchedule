...
type ScheduleSettings struct {
	...
	MondayPmAppointmentType	int	`gorm:"column:monday_pm_appointment_type;type:varchar(5)" json:"mondayPmAppointmentType"`
	...
	TuesdayPmAppointmentType	int	`gorm:"column:tuesday_pm_appointment_type;type:varchar(5)" json:"tuesdayPmAppointmentType"`
	...
	WednesdayPmAppointmentType	int	`gorm:"column:wednesday_pm_appointment_type;type:varchar(5)" json:"wednesdayPmAppointmentType"`
	...
	ThursdayPmAppointmentType	int	`gorm:"column:thursday_pm_appointment_type;type:varchar(5)" json:"thursdayPmAppointmentType"`
	...
	FridayPmAppointmentType	int	`gorm:"column:friday_pm_appointment_type;type:varchar(5)" json:"fridayPmAppointmentType"`
	...
	SaturdayPmAppointmentType	int	`gorm:"column:saturday_pm_appointment_type;type:varchar(5)" json:"saturdayPmAppointmentType"`
	...
	SundayPmAppointmentType	int	`gorm:"column:sunday_pm_appointment_type;type:varchar(5)" json:"sundayPmAppointmentType"`
