...
type ScheduleSettings struct {
	...
	MondayAmAppointmentType	int	`gorm:"column:monday_am_appointment_type;type:int(11)" json:"mondayAmAppointmentType"`
	...
	MondayPmAppointmentType	string	`gorm:"column:monday_pm_appointment_type;type:varchar(5)" json:"mondayPmAppointmentType"`
	...
	TuesdayAmAppointmentType	int	`gorm:"column:tuesday_am_appointment_type;type:int(11)" json:"tuesdayAmAppointmentType"`
	...
	TuesdayPmAppointmentType	string	`gorm:"column:tuesday_pm_appointment_type;type:varchar(5)" json:"tuesdayPmAppointmentType"`
	...
	WednesdayAmAppointmentType	int	`gorm:"column:wednesday_am_appointment_type;type:int(11)" json:"wednesdayAmAppointmentType"`
	...
	WednesdayPmAppointmentType	string	`gorm:"column:wednesday_pm_appointment_type;type:varchar(5)" json:"wednesdayPmAppointmentType"`
	...
	ThursdayAmAppointmentType	int	`gorm:"column:thursday_am_appointment_type;type:int(11)" json:"thursdayAmAppointmentType"`
	...
	ThursdayPmAppointmentType	string	`gorm:"column:thursday_pm_appointment_type;type:varchar(5)" json:"thursdayPmAppointmentType"`
	...
	FridayAmAppointmentType	int	`gorm:"column:friday_am_appointment_type;type:int(11)" json:"fridayAmAppointmentType"`
	...
	FridayPmAppointmentType	string	`gorm:"column:friday_pm_appointment_type;type:varchar(5)" json:"fridayPmAppointmentType"`
	...
	SaturdayAmAppointmentType	int	`gorm:"column:saturday_am_appointment_type;type:int(11)" json:"saturdayAmAppointmentType"`
	...
	SaturdayPmAppointmentType	string	`gorm:"column:saturday_pm_appointment_type;type:varchar(5)" json:"saturdayPmAppointmentType"`
	...
	SundayAmAppointmentType	int	`gorm:"column:sunday_am_appointment_type;type:int(11)" json:"sundayAmAppointmentType"`
	...
	SundayPmAppointmentType	string	`gorm:"column:sunday_pm_appointment_type;type:varchar(5)" json:"sundayPmAppointmentType"`
	UpdatedAt	time.Time	`gorm:"column:updated_at;type:dateTime" validate:"hh:mm" json:"updatedAt"`
	CreatedAt	time.Time	`gorm:"column:created_at;type:dateTime" validate:"hh:mm" json:"createdAt"`
}
